...
try:
    ...
    from backports import zoneinfo # Fallback if needed

def process_observations(observations):
    # KATL is Eastern Time (America/New_York)
    # We use valid_time_gmt and convert using timezone library
    ...
    for obs in observations:
        ...
        # Convert to Local Time correctly handling DST
